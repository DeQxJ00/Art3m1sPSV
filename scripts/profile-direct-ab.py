...
def main():
    ...
    parser.add_argument('--mode', choices=['profile', 'layout', 'commands', 'keys', 'waits', 'history', 'messages', 'order'], default='profile')
    ...
    control, marker, banner = {
        ...
        'history': ('history-cache.off', '[history-state]', b'optM history cache'),
