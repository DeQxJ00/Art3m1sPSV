...
$reply = Invoke-WebRequest -Uri 'http://127.0.0.1:32560/mcp' -Method Post -ContentType 'application/json' -Headers @{Accept='application/json, text/event-stream'} -Body $payload -TimeoutSec 45
