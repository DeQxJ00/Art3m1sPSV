...
files=['main.cpp','gpu.cpp','gpu.hpp','bridge.cpp','menu.cpp','fallback_menu.hpp','fallback_menu_atlas.hpp','font_settings.hpp','font_settings_menu.hpp','cpu3_setting.hpp','loading_ps_guard.hpp','diagnostic_io.hpp','status_cache.hpp','log_queue.hpp','resource_ledger.hpp','opaque_tiles.hpp','opaque_scan_probe.hpp','shared_surface_pixels.hpp','image_certificate.hpp']
errors=[];hashes={}
for name in files:
