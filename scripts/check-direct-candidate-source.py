...
files=['main.cpp','gpu.cpp','gpu.hpp','bridge.cpp','diagnostic_io.hpp','status_cache.hpp','log_queue.hpp','resource_ledger.hpp','opaque_tiles.hpp','opaque_scan_probe.hpp','shared_surface_pixels.hpp']
errors=[];hashes={}
for name in files:
