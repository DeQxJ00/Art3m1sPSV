...
#ifdef __PSV__
    // Physical Vita buttons. Keep the existing confirm/cancel swap mapping,
    // and use geometric glyphs present in the launcher's CJK font.
    switch (button)
    {
        case BUTTON_A: return "\u00D7";
        case BUTTON_B: return "\u25CB";
        case BUTTON_X: return "\u25A1";
        case BUTTON_Y: return "\u25B3";
        case BUTTON_START: return "START";
        case BUTTON_BACK: return "SELECT";
        default: break;
    }
#endif
